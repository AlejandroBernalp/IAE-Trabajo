...
# 2. IMPORTACIÓN DIRECTA DESDE URL (Solución al problema de descarga vacía)
url <- "https://archive.ics.uci.edu/ml/machine-learning-databases/statlog/german/german.data"
X <- read.table(url, header = FALSE, sep = " ")

# 3. CAMBIO DE NOMBRES (Exactamente como los tuyos)
nuevos_nombres <- c(
...
# 4. RECODIFICACIÓN (Mantenemos tu lógica A11, A12...)
X <- X %>%
  mutate(
